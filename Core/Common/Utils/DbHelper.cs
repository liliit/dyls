...
namespace DYLS.Common.Utils
{
    public static class DbHelper
    {
        ...
        /// <returns></returns>
        public static int GetCount(string table, string where, object param = null)
        {
            return GetCurrentConnection().QueryFirstOrDefault<int>("select count(*) from " + table + " as obj where " + where, param);
        }
